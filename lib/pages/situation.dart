...
'В шейном и поясничном отделах толще спинной мозг, так как здесь от него отходят нервы к руке и ноге. В соответствии с толщиной спинного будут толще и позвоночные отверстия',
  'Студент-первокурсник на практике изучал компьютерную томограмму позвоночника и заметил, что позвоночные отверстия в шейном и поясничном отделах крупнее, чем в грудном. Как бы вы объяснили данный феномен?'];
